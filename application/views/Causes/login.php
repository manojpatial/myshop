...
<section class='causes-log'>
    ...
    <option value="<?php echo base_url(); ?>LangSwitch/switchLanguage/chinese" <?php echo $this->lang->line('language_key') == "Chinese" ? "selected" : "";  ?>>Chinese</option>
		...
		<div class='row top50 justify-content-center'>
			<div class='col-sm-6'>
				<form action="<?php echo base_url('Causes/login'); ?>" role="form" id="login" method="POST" class="login-form">
					<div class='form-row'>
					...
					<div class='form-row'>
						<label class='col-sm-12'><a href='<?php echo base_url('Causes/register');?>'><?php echo $this->lang->line('login_create_account'); ?></a></label>
