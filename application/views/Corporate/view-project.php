...
<div id="project-page" class='container-fluid' style="background:linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url('<?php echo base_url();?>assets/uploads/cause-picture/<?php echo $cause_data->photo; ?>') no-repeat;">
	...
	<div class='row com50' id='certificates-listing'>
		...
		<div class='institution-text'>
			<span>Institution:</span><br><?php echo $cause_userdata['cause_institution']; ?>
		</div>
		</div>
		...
		<?php //echo '<pre>'; print_r($cert_data); ?>
			<div id='certificates-area'>
				...
				<div class='box row'>
					<div class='box1 title col-lg-3 col-md-3  text-right'>Certificates </div>
					...
					<?php 
						...
						<div class='cert_corpo'>
							<strong>Corporate Benefits:<br></strong>
							<?php echo  $cert['cert_corporate_benefits']; ?>
						</div>
						<div class='cert_serv '>
							<strong>Restriction:<br></strong>
			...
			<div id='service-area'>
				...
				<div class='box row'>
					<div class='box1 title col-lg-3 col-md-3  text-right'>Service </div>
		...
		<div class='col-lg-12 col-md-12'><button id="back-cert" type="button" class="btn creat-btn">Back</button></div>
	</div>
		...
		<div class='col-lg-12 col-md-12'><button type="button" class="btn creat-btn back_to_stage">Back</button></div>
		</div>
		<?php $i++;
		} ?>
