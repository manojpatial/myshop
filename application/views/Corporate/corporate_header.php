...
<link href="<?php echo base_url();?>assets/css/corporate.css" rel="stylesheet" type="text/css"> 
</head>
					...
					<?php $loginData = $this->session->userdata('logged_in');
						...
						?>
							<div class='avt-sec'>
								...
								<img src="<?php echo base_url();?>assets/uploads/corporate-logo/<?php echo $loginlogoimage ;?>" alt="Avatar" class="avatar">
							</div>
				  <?php } ?>
