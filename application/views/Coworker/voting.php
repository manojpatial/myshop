...
<br>	  
		...
		<div class="hover_bkgr_fricc">
			...
			<div>
				...
				<li id="vote-4" class="vote-cir-individual"><span>Vote</span></li>
		...
		<div class='container-fluid'>
			...
			<div class='button-group text-right top30'>
				<button type='button' id="vote-submit" class='btn create-btn btn-disable'>Submit</button>
			</div>
		</div>	
	</div>
	...
	<div id="voting_thanks" class="popup">
		...
		<div class="popup_body">
			...
			<p>Result will be available on <?php echo $new_end_date; ?></p>
			<div class='pop_buttons'>
			<button id="" type="button" class="back_but btn create-btn">Back</button>
