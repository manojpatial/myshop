$(document).ready(function() {
	...
	$(document).on("click", ".cert_save", function() {
		...
		if(dbCertId =='') //update certificae
		{
			...
			$.ajax({
				type: "POST",
				url: base_url+"/Causes/cause_creation_save_certificates",
				data: dataString,
				dataType: 'json',
				cache: false,
			...
			$.ajax({
				type: "POST",
				url: base_url+"Causes/cause_creation_update_certificates",
				data: dataString,
				dataType: 'json',
				cache: false,
				success: function(result){
	...
	$(document).on("click", ".cert_remove", function() {
		...
		if (confirm(remove_cert_confirm)) {
			$.ajax({
				type: "POST",
				url: base_url+"Causes/delete_certificate",
				data: "certid="+certid,
				dataType: 'json',
				cache: false,
				success: function(result){
	...
	$(document).on("click", ".serv_save", function() {
		...
		{	
			...
			$.ajax({
				type: "POST",
				url: base_url+"/Causes/cause_creation_save_services",
				data: dataString,
				dataType: 'json',
				cache: false,
				success: function(result){
			...
			$.ajax({
				type: "POST",
				url: base_url+"Causes/cause_creation_update_services",
				data: dataString,
				dataType: 'json',
				cache: false,
				success: function(result){
	...
	$(document).on("click", ".serv_remove", function() {
		...
		if (confirm(remove_serv_confirm)) {
			$.ajax({
				type: "POST",
				url: base_url+"Causes/delete_service",
				data: "servid="+servid,
				dataType: 'json',
				cache: false,
				success: function(result){
	...
	$(document).on("click", "#infonext", function() {
		...
		else
		{
			...
			if(cause_id =='')
			{
				$.ajax({
					type: "POST",
					url: base_url+"Causes/cause_creation_save_info",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
				...
				$.ajax({
					type: "POST",
					url: base_url+"Causes/cause_creation_update_info",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
					 ...
					 html += '<div class="modal-body">';
						...
						html += '<form method="post" class="add-activity">';
							...
							html += '<input type="hidden" class="db-act-id" value="">';
								html += '<button type="button" class="btn create-btn">Save</button>';
							html += '</div>';
						html += '</form>';
					  html += '</div>';
					 html += '</div>';
	...
	$(document).on("click", ".add-activity .create-btn", function() {
		...
		else
		{
			if(dbActId !='') //update activity
			{
				$.ajax({
					type: "POST",
					url: base_url+"/Causes/cause_creation_update_activity",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
				...
				$.ajax({
					type: "POST",
					url: base_url+"Causes/cause_creation_save_activity",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
	...
	$(document).on("click", ".btn.add-stage-btn", function() {
		...
		if(stageName==''||stageNumber==''||stageDescription=='')
		{
			...
			if(dbStgId == '')
			{
				$.ajax({
					type: "POST",
					url: base_url+"Causes/cause_creation_save_stage",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
								...
								html +='<div class="col-sm-6">';
									html +='<form method="post" class="steps-form add-stage">';
										...
										html += '<input type="hidden" class="db-stg-id" value="">';
											...
											html +='<button id="next-stage-'+nextId+'" type="button" class="next btn create-btn add-stage-btn" style="margin-left: 5px;">Save Stage</button>';
				...
				$.ajax({
					type: "POST",
					url: base_url+"Causes/cause_creation_update_stage",
					data: dataString,
					dataType: 'json',
					cache: false,
					success: function(result){
	...
	$(document).on("click", "#tab_project a, #finish-stages", function() {
		...
		$.ajax({
			type: "POST",
			url: base_url+"Causes/get_view_ajax",
	...
	$(document).on("click", ".finish-cause", function() {
		...
		$.ajax({
			type: "POST",
			url: base_url+"Causes/finish_cause",
			data: "cause_id="+cause_id,
			dataType: 'json',
			cache: false,
			success: function(result){
